...
gulp.task('setup-uswds', gulp.parallel('copy-uswds-images', 'copy-uswds-js', 'copy-uswds-fonts', 'copy-uswds-scss'))

gulp.task('build', gulp.series('setup-uswds', 'styles', 'scripts', 'eslint'))
